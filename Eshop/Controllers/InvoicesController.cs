...
namespace Eshop.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            //var eshopContext = _context.Invoices.Include(i => i.Account).Where(inv => inv.Account.Id == 2);
            //var eshopContext = _context.Accounts.Include(i => i.Invoices).Where(acc => acc.Id == 2).FirstOrDefault().Invoices;
            return View(await _context.Invoices.ToListAsync());
            //return View(eshopContext);
        }
